...
namespace Demo.MLNetModelBuilder.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"..\..\..\..\SMSSpamCollection.tsv";
        private static string MODEL_FILEPATH = @"..\..\..\..\Demo.MLNetModelBuilder.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "IsSpam", numberOfIterations: 10, featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "IsSpam");
