...
namespace Demo.MLNetModelBuilder.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"..\..\..\..\SMSSpamCollection.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.IsSpam} | Predicted value: {predictionResult.Prediction}");
